...
import { PacverseRoom } from "../PacverseRoom";
 ...
 */
let gameLoop = function (roomRef: PacverseRoom, deltaTime: number) {
...
customMethods.scoreTarget = function (roomRef: PacverseRoom, client: Client, request: any) {
 ...
 */
let scoreTargetForEntity = function (roomRef: PacverseRoom, entityID: string, target: any) {
 ...
 */
let getTargetSet = function (roomRef: PacverseRoom, numOfTargets: number) {
 ...
 */
let setUsersAttribute = function (roomRef: PacverseRoom, key: string, value: string) {
 ...
 * @param {*} value The value of the attribute you want to set
 */
let setRoomAttribute = function (roomRef: PacverseRoom, key: string, value: string) {
 ...
 */
let getGameState = function (roomRef: PacverseRoom, gameState: string) {
 ...
 * @param {*} roomRef Reference to the room
 */
let getRoundWinner = function (roomRef: PacverseRoom) {
...
let resetForNewRound = function (roomRef: PacverseRoom) {
...
let unlockIfAble = function (roomRef: PacverseRoom) {
 ...
 */
let moveToState = function (roomRef: PacverseRoom, newState: string) {
 ...
 */
let waitingLogic = function (roomRef: PacverseRoom, deltaTime: number) {
 ...
 * @param {*} deltaTime Server delta time in seconds
 */
let sendTargetsLogic = function (roomRef: PacverseRoom, deltaTime: number) {
 ...
 * @param {*} deltaTime Server delta time in seconds
 */
let beginRoundLogic = function (roomRef: PacverseRoom, deltaTime: number) {
 ...
 * @param {*} deltaTime Server delta time in seconds
 */
let simulateRoundLogic = function (roomRef: PacverseRoom, deltaTime: number) {
 ...
 * @param {*} deltaTime Server delta time in seconds
 */
let endRoundLogic = function (roomRef: PacverseRoom, deltaTime: number) {
 ...
 */
exports.InitializeLogic = function (roomRef: PacverseRoom, options: any) {
 ...
 */
exports.ProcessLogic = function (roomRef: PacverseRoom, deltaTime: number) {
 ...
 */
exports.ProcessMethod = function (roomRef: PacverseRoom, client: Client, request: any) {
 ...
 */
exports.ProcessUserLeft = function (roomRef: PacverseRoom) {
    if (roomRef.locked) {
        switch (getGameState(roomRef, CurrentState)) {
            case ServerGameState.Waiting:
                unlockIfAble(roomRef);
